    ...
    >
      ...
      >
        ...
        <p className=" leading-5  lg:leading-8 text-[.9rem] xl:text-2xl font-thin">
          Are you still flying regularly in Battlefield? Do you want to stay in
          closer contact with other dogfighters? Then you’ll want to join the
          IDF community! We play all the Battlefield games and welcome everyone,
          regardless of background, appearance, age, religion, gender, or
          preferences. As part of our Dogfight Community, anyone interested in
          flying Jets/Bombers in Battlefield can join and be part of our vibrant
          group. We offer both unranked and ranked servers sponsored by our
          members. Joining is completely free, and we aim to preserve the spirit
          of Battlefield Dogfighting. Follow our Discord link, complete the
          application steps, and start playing with us today!
        </p>
        <button
